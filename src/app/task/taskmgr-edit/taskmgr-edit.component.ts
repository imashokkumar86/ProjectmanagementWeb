...
export class TaskmgrEditComponent implements OnInit {
  ...
  public users: User[];
  constructor(private projectService: ProjectService, private userService: UserService,private parentService: ParentTaskService,
  ...
  ngOnInit() {
    ...
    this.taskManagerService.GetTask(this.updateTaskId).subscribe(
      response => {
       ...
       this.parentService.GetTask(this.taskDetail.parentId).subscribe(
          parentTaskResponse => {
